...
class TestDjango(TestCase):
    ...
    def test_user_name_is_required_(self):
        ...
        self.assertEqual(form.errors['your_name']
    ...
    def test_dinning_time_is_required_(self):
        ...
        self.assertEqual(form.errors['dinning_time']
                         [0], 'This field is required.')
    ...
    def test_arriving_date_is_required_(self):
        ...
        self.assertEqual(form.errors['arriving_date']
                         [0], 'This field is required.')
    ...
    def test_number_of_people_is_required_(self):
        ...
        self.assertEqual(form.errors['number_of_people']
                         [0], 'This field is required.')
    ...
    def test_nigiri_option_required_(self):
        ...
        self.assertEqual(form.errors['nigiri_sushi']
                         [0], 'This field is required.')
    ...
    def test_inari_option_required_(self):
        ...
        self.assertEqual(form.errors['inari_sushi']
                         [0], 'This field is required.')
    ...
    def test_maki_option_required_(self):
        ...
        self.assertEqual(form.errors['maki_sushi']
                         [0], 'This field is required.')
    ...
    def test_temaki_option_required_(self):
        ...
        self.assertEqual(form.errors['temaki_sushi']
                         [0], 'This field is required.')
    ...
    def test_toppings_option_required(self):
        ...
        self.assertEqual(form.errors['toppings_choice']
                         [0], 'This field is required.')
    ...
    def test_soup_option_required(self):
        ...
        self.assertEqual(form.errors['soup_choice']
                         [0], 'This field is required.')
    ...
    def test_side_dish_option_required(self):
        ...
        self.assertEqual(form.errors['side_dish']
                         [0], 'This field is required.')
    ...
    def test_green_tea_option_required(self):
        ...
        self.assertEqual(form.errors['green_tea']
                         [0], 'This field is required.')
    ...
    def test_ramen_order_form_exclusive_for_meta(self):
        ...
        self.assertEqual(form.Meta.fields, [
                         "toppings_choice", "side_dish", "soup_choice"])

    def test_drink_order_form_exclusive_for_meta(self):
        form = DrinkOrder()
        self.assertEqual(form.Meta.fields, [
                         "sake", "beer", "choya", "green_tea", "water"])

    def test_sushi_order_form_exclusive_for_meta(self):
        form = SushiOrder()
        self.assertEqual(form.Meta.fields, [
                         "nigiri_sushi", "inari_sushi", "maki_sushi", "temaki_sushi", "soy_oil", "wasabi"])
