...
class Sushi(models.Model):
    ...
    MAKI_SUSHI = (
        (1, "salmon, tuna, amberjack x 6"),
        (2, "cucumber, carrot and egg x 6"),
    ...
    TEMAKI_SUSHI = (
        (1, "Crab, cucumber x 3 "),
        (2, "shrimp, cucumber  x 3 "),
        (3, "Ikura, egg, salad  x 3 "),
        (4, "Salmon  x 3 "),
        (5, "None")
    )
    ...
    maki_sushi = models.IntegerField(
        choices=MAKI_SUSHI, default=1)
    temaki_sushi = models.IntegerField(
        choices=TEMAKI_SUSHI, default=1)
